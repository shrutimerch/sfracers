...
export const routeProfiles:Record<number,RouteProfile>={
 ...
 112775863:{color:'#bdb4a0',trim:'#d4cbb7',frames:'#424a46',floors:2,grid:true,bay:5}, // Second/De Boom to Brannan
 ...
 148325245:{color:'#b57b62',trim:'#bfc7c6',frames:'#364743',floors:5,grid:true,bay:4}, // Third/Townsend apartments
 129176901:{color:'#b79d64',trim:'#9e5547',frames:'#3f3934',floors:2,bay:4}, // Third/Townsend low retail
 124890326:{color:'#c8bd91',trim:'#dcd9bf',frames:'#a2b1ad',floors:4,grid:true,bay:4}, // Third/Brannan and Varney
 124903637:{color:'#d2d3ca',trim:'#e4e2d6',frames:'#444e4c',floors:2,bay:4}, // Third/Brannan pale low corner
 113545685:{color:'#8c5d4f',trim:'#b0b4ac',frames:'#424f4c',floors:3,grid:true,bay:3.5}, // Jack London modern corner
