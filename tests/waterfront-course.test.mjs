...
test('waterfront circuit is a continuous closed route on source street segments',()=>{
 ...
 assert.ok(Math.abs(length-d.course.length)<.02);assert.ok(length>2100&&length<2250);assert.ok(length/27>60,'even sustained top speed takes over a minute');assert.ok(length/19>110&&length/19<120);
