...
legs=[('South Park',(-7.71,588.26),(186.72,392.26)),('2nd Street',(186.72,392.26),(255.89,460.18)),('Brannan Street',(255.89,460.18),(597.85,139.16)),('The Embarcadero',(597.85,139.16),(577.35,467.0)),('King Street',(577.35,467.0),(268.55,869.84)),('3rd Street',(268.55,869.84),(-7.71,588.26))]
...
out={**d,'route':route,'course':{'name':'South Park Waterfront Circuit','length':round(length,2),'sections':sections,'targetSeconds':120,'description':'South Park → 2nd → Brannan → Embarcadero → King → 3rd','source':'Existing OpenStreetMap street centerlines; closed-course game ignores normal traffic directions.'}}
