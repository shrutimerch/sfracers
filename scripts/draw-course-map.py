...
for road in d['roads']+d.get('paths',[]):s.append(f'<polyline points="{p(road["points"])}" fill="none" stroke="#fcfffc" stroke-width="5"/>')
...
s.append('<text x="40" y="35" font-family="sans-serif" font-size="18" fill="#183b43">A · WATERFRONT CIRCUIT — 2.18 KM</text><text x="940" y="40" font-family="sans-serif" font-size="20">N ↑</text><text x="40" y="825" font-family="sans-serif" font-size="14">Mapped street centerlines · © OpenStreetMap contributors</text></svg>')
